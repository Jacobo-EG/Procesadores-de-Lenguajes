...
public class parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\017\000\006\005\005\006\010\001\002\000\010\002" +
    "\021\005\005\006\010\001\002\000\004\007\016\001\002" +
    "\000\010\002\uffff\005\uffff\006\uffff\001\002\000\004\004" +
    "\014\001\002\000\004\007\012\001\002\000\006\004\ufffd" +
    "\007\013\001\002\000\006\004\ufffa\007\ufffa\001\002\000" +
    "\006\004\ufffb\007\ufffb\001\002\000\010\002\ufffe\005\ufffe" +
    "\006\ufffe\001\002\000\006\004\ufffc\007\017\001\002\000" +
    "\006\004\ufff8\007\ufff8\001\002\000\006\004\ufff9\007\ufff9" +
    "\001\002\000\010\002\001\005\001\006\001\001\002\000" +
    "\004\002\000\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\017\000\010\002\003\003\005\006\006\001\001\000" +
    "\006\003\017\006\006\001\001\000\004\005\014\001\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 Test.out.print(":" + i + ":int; ");  RESULT = ":" + i + ":int; " + e; 
		...
		int iright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 Test.out.print(":" + i + ":int; "); RESULT = ":" + i + ":int;" ; 
		...
		String d = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 Test.out.print(":" + d + ":double; "); RESULT = ":" + d + ":double; " + e; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("double",3, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		int dright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		String d = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 Test.out.print(":" + d + ":double; "); RESULT = ":" + d + ":double;" ; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("double",3, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
